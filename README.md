...
[![Latest Stable Version](https://poser.pugx.org/nueip/codeigniter-model/v/stable?format=flat-square)](https://packagist.org/packages/nueip/codeigniter-model)
[![License](https://poser.pugx.org/nueip/codeigniter-model/license?format=flat-square)](https://packagist.org/packages/nueip/codeigniter-model)
